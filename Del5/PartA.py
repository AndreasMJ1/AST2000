...
if __name__ =='__main__':
    ...
    timep = 6717+5*231
    #plt.quiver(0.258721194372766, -2.666619325520842, 1.03, 0.73)
    #plt.quiver(0.6130565638511531, -2.542328861465358, 9.118023102360207e-05, 0.00030788849965265045)
    #plt.quiver(-0.00043991393, 1.22575507, -0.21355420999999986, 0.14064851)
    plt.show()
